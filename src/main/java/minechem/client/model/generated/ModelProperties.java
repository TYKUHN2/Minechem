...
import minechem.client.model.generated.ModelProperties.PerspectiveProperties.PerspectiveBuilder;
...
public class ModelProperties {
	...
	public static class PerspectiveProperties extends ModelProperties {
		...
		public static final PerspectiveProperties DEFAULT_ITEM = new PerspectiveProperties(Transforms.DEFAULT_ITEM, true, false);
		public static final PerspectiveProperties DEFAULT_BLOCK = new PerspectiveProperties(Transforms.DEFAULT_BLOCK, true, true);
		...
		public static PerspectiveProperties createFromModel(PerspectiveAwareBakedModel model) {
			return new PerspectiveProperties((PerspectiveProperties) model.properties);
		}
