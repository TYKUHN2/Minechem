...
class MinechemClassesAccess {
	...
	static {
		...
		classChemicalRoomStateEnum = getClassSafely("minechem.item.MatterState", isInstalled);
		...
		classDecomposerRecipe = getClassSafely("minechem.recipe.RecipeDecomposer", isInstalled);
		classSynthesisRecipe = getClassSafely("minechem.recipe.RecipeSynthesis", isInstalled);
		classDecomposerFluidRecipe = getClassSafely("minechem.recipe.RecipeDecomposerFluid", isInstalled);
